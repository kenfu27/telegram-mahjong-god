...
class Game(Timestamps, Base):
    ...
    player_1_id = Column(String(64), ForeignKey('player.username'), nullable=True)
    player_2_id = Column(String(64), ForeignKey('player.username'), nullable=True)
    player_3_id = Column(String(64), ForeignKey('player.username'), nullable=True)
    player_4_id = Column(String(64), ForeignKey('player.username'), nullable=True)
